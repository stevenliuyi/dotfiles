...
# install packages
packages="awscli binutils build-essential cmake curl gcc g++ make software-properties-common texlive tmux p7zip p7zip-rar python-pip zsh vim autojump r-base r-base-dev gdebi-core unrar shellcheck htop trash-cli silversearcher-ag"
